                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action = "/web2/index.php" onsubmit="return authenticate()">
                                    <form class="user">
                                    ...
                                    function authenticate(){
                                        ...
                                        if(username == "admin" && password == "ahram"){
                                        authorised = true;
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="small"> Call your admin for username and password </p>
                                    </div>
                                </div>
                            </div>
                        </div>
